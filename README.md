...
pkg install python git libjpeg-turbo libpng freetype clang -y

These libraries are required to build Pillow on Termux.
...
GitHub : https://github.com/cameleonnbss
...
💡 Petit conseil (optionnel mais important) :
si un jour tu renommes ton repo en camzzz-tool, ton projet sera beaucoup plus trouvable sur GitHub.```
